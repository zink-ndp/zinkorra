            ...
            <div class="row">
                    ...
                    <form id="signForm" role="form" method="post" action="sign.php">
                      <div class="mb-3">
                        <input required type="text" name="name" class="form-control form-control-lg"
                          placeholder="Nhập họ và tên của bạn" aria-label="Name" id="Name">
                      </div>
                      <div class="mb-3">
                        <input required type="tel" name="phone" class="form-control form-control-lg"
                          placeholder="Nhập số điện thoại" aria-label="Password" id="">
                      </div>
                      <div class="mb-3">
                        <input required type="email" name="email" class="form-control form-control-lg"
                          placeholder="Nhập Email" aria-label="Username" id="email">
                      </div>
                      <div class="mb-3">
                        <input required type="password" name="pass" class="form-control form-control-lg"
                          placeholder="Nhập Mật khẩu" aria-label="Password" id="passInput">
                      </div>
                      <div class="mb-3">
                        <input required type="password" name="repass" class="form-control form-control-lg"
                          placeholder="Nhập lại Mật khẩu" aria-label="RePassword" id="passReput">
                      </div>
                      ...
                      <div class="text-center">
                        <button type="submit" class="theme-btn btn-style-four w-100 mt-n1 mb-0"><span class="txt">Đăng
                            kí ngay</span></button>
                      </div>
              ...
              <div
                ...
                <div
                  ...
                  style="background-image: url('https://images.unsplash.com/photo-1606744824163-985d376605aa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80'); background-size: cover;">
                  ...
                  <p class="text-white position-relative">Đăng nhập ngay để có trải nghiệm tuyệt vời <br> và nhận những
                    ưu đãi hấp dẫn!</p>
                  <div class="text-center">
                    <a href="login.php" type="submit" class="theme-btn btn-style-two w-30 mt-5 mb-0"><span
                        class="txt">Đăng nhập</span></a>
                  </div>
                </div>
              </div>
            </div>
