        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              <div class="brand-text brand-big visible text-uppercase"><strong class="text-primary">Zink</strong><strong>Orr'a</strong></div>
              <div class="brand-text brand-sm"><strong class="text-primary">Z</strong><strong>O</strong></div></a>
            <!-- Sidebar Toggle Btn-->
          ...
          <div class="right-menu list-inline no-margin-bottom">    
            ...
            <div class="list-inline-item logout">                   
              <a id="logout" href="login.php" class="nav-link">Đăng xuất <i class="icon-logout"></i></a>
            </div>
          </div>
        </div>
      </nav>
