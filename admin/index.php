          ...
          <div class="row d-flex justify-content-between">
            ...
            <div>
              <form action="#" class="form-inline">
                <a href="index.php" style="margin-right: 10px;"><input type="button" value="Đặt về mặc định" class="btn btn-dark"></a>
              ...
              <div class="statistic-block block py-4">
                <div class="d-flex justify-content-between">
                  <span>
                    ...
                    <span style="font-size: 17px; color: #ffd300"><?php echo $spbannhieunhat ?></span>
                  </span>
