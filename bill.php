                    ...
                    <form method="get" action="bill.php" class="mt-2">
                        <div class="search-box">
                            ...
                            <input class="search" type="text" name="search" value=""
                                placeholder="Tìm theo mã hoá đơn, tên sản phẩm, ngày đặt,..." required>
            ...
            <div class="auto-container">
                ...
                <style>
                    ...
                    .shop-fill {
                        ...
                        /* Các phần tử con nằm ở hai bên cùng */
                        align-items: center;
                    ...
                    .fill {
                        width: 100%;
                        /* Độ rộng của hai div con */
                        padding: 5px;
                        /* Khoảng cách trong hai div con */
                        display: flex;
                        flex-direction: row;
                    }
                ...
                <div class="row clearfix">
                    ...
                    $sql = "select b.*, c.CTM_ID, s.* from bill b
                            ...
                            where b.CTM_ID = {$_SESSION['id']} order by b.B_DATE desc".$cond;
                    ...
                    if ($result && $result->num_rows>0) {
                        ...
                        foreach ($result_all as $row) {
                            ...
                            <div class="container-fluid mt-5" style="box-shadow: 10px 10px 8px rgba(0,0,0,0.2);">
                                <div class="row" style="padding: 10px; border-bottom: 1px dashed #ededed">
                                    <div class="col-lg-9 col-md-7" style="font-weight: bold; font-size: 16px;">
                                        <?php echo date_format(date_create($row['B_DATE']), 'd-m-Y') ?> _ Mã hoá đơn:
                                        <?php echo $bid ?>
                                        <a href="bill-detail.php?bid=<?php echo $bid ?>" target="_blank"><i class="fas fa-print"></i> In </a>
                                    </div>
                                    <div class="col-lg-3 col-md-5"
                                        style="text-align: right; text-transform: uppercase; color: #dfb162; font-weight: bold;">
                                        ...
                                        <div class="row rate" style="padding: 10px; margin: 10px;  border-bottom: 1px dashed #ededed">
                                            <div class="col-1" style="border: 1px solid #f0f0f0; width: 80px; height: 80px;">
                                                <img style="height: 100%; width: 100%; object-fit: cover"
                                                    src="images/products/<?php echo $pd['PD_PIC'] ?>" alt="">
                                            </div>
                                            <div class="col-8">
                                                <a href="product-detail.php?id=<?php echo $pd['PD_ID'] ?>">
                                                    <span style="color: #dfb162; font-size: 17px; font-weight: bold;">
                                                        <?php echo $pd['PD_NAME'] ?>
                                                    </span><br>
                                                </a>
                                                <span>Số lượng:
                                                    <?php echo $pd['PD_QUANT'] ?>
                                                </span><br>
                                            </div>
                                            <div class="col-2 mt-3" style="text-align: right;">
                                                <span style="font-size: 16px; color: black">
                                                    <?php echo number_format($pd['PD_PRICE']) ?>đ
                                                </span>
                                            </div>
                                            <?php
                                            if ($row['ST_ID'] == 3) {
                                                ...
                                                ?>
                                                <div class="col-1">
                                                    <button class="theme-btn btn-style-four mt-2 " type="button" <?php echo $isExpire ?>
                                                        style="padding: 2px 6px !important; font-size: 10px !important">
                                                        <span data-target="rate-box-<?php echo $pd['PD_ID']; ?>" class="txt rate-btn"><i
                                                                class="fas fa-star"></i> RATE</span>
                                                    </button>
                                                </div>
                                                <div class="col-12">
                                                    <div id="rate-box-<?php echo $pd['PD_ID']; ?>" style="display: none;"
                                                        class="shop-comment-form mt-4 rate-box">
                                                        <div style="width: 40%; 
                                                    background-color: white; 
                                                    padding: 3rem 0rem; 
                                                    z-index: 999; 
                                                                ...
                                                                <div class="row clearfix">
                                                                    ...
                                                                    <div class="col-8">
                                                                        <div class="rating-box">
                                                                            ...
                                                                            <div class="rating">
                                                                                <a id="star-<?php echo $pd['PD_ID']; ?>"
                                                                                    class="astar1"><span class="fa fa-star"></span></a>
                                                                            </div>
                                                                            <div class="rating">
                                                                                <a id="star-<?php echo $pd['PD_ID']; ?>"
                                                                                    class="astar2"><span class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span></a>
                                                                            </div>
                                                                            <div class="rating">
                                                                                <a id="star-<?php echo $pd['PD_ID']; ?>"
                                                                                    class="astar3"><span class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span></a>
                                                                            </div>
                                                                            <div class="rating">
                                                                                <a id="star-<?php echo $pd['PD_ID']; ?>"
                                                                                    class="astar4"><span class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span></a>
                                                                            </div>
                                                                            <div class="rating">
                                                                                <a id="star-<?php echo $pd['PD_ID']; ?>"
                                                                                    class="astar5"><span class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span><span
                                                                                        class="fa fa-star"></span></a>
                                                                        ...
                                                                        <div class="row clearfix">
                                                                            ...
                                                                            <input type="hidden" name="pdid"
                                                                                value="<?php echo $pd['PD_ID'] ?>">
                                                                            <div id="rate-<?php echo $pd['PD_ID']; ?>"></div>
                                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group"
                                                                                style="display: flex; justify-content: right;">
                                                                                <button class="theme-btn btn-style-four" type="submit"
                                                                                    name="submit-form"><span class="txt">Gửi</span></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-2">
                                                                        <button id="close-<?php echo $pd['PD_ID']; ?>" type="button"
                                                                            class="btn btn-link text-danger close-button">Đóng X</button>
                                                                    </div>
                                                                </div>
                                                                <script>
                                ...
                                <div class="row px-2">
                                    <div class="col-12" style="text-align: right;">
                                        <span style="font-size: 15px;">Tạm tính:</span>
                                        <span style="font-size: 19px; font-weight: bold; color: #dfb162">
                                            <?php echo number_format($tt) ?>đ
                                        </span>
                                    </div>
                                </div>
                                <div class="row" style="padding: 10px;">
                                    <div class="col-6">
                                        <span style="font-size: 15px; font-style: italic; color: #dfb162">Mã giảm giá:
                                            <?php
                                            if ($row['SL_CODE'] != null) {
                                                $saleRs = querySqlwithResult($conn, "select SL_PERCENT as perc from sale where SL_CODE = '{$row['SL_CODE']}'");
                                                $gg = $saleRs->fetch_assoc();
                                                echo ' ' . $row['SL_CODE'] . ' - ' . $gg['perc'] . '% - Giảm ' . number_format($tt * ($gg['perc'] / 100)) . ' đ';
                                                $giam = $tt * ($gg['perc'] / 100);
                                            } else {
                                                echo ' Không áp dụng';
                                                $giam = 0;
                                    ...
                                    <div class="col-6" style="text-align: right">
                                        ...
                                        <span style="font-size: 19px; font-weight: bold; color: #dfb162">
                                            <?php echo number_format($tt - $giam) ?>đ
                                        </span>
                                    </div>
                                </div>
                                        ...
                                        if ($row['ST_ID'] == 3) {
                                            ...
                                            <a href="rebuy.php?id=<?php echo $bid ?>">
                                                <button type="button" class="theme-btn btn-style-four"
                                                    style="margin-left: 15px !important; padding: 5px 15px !important; background-color: #888 !important"><span
                                                        class="txt">Mua lại</span></button>
                                            </a>
                                            <?php
                                        } elseif ($row['ST_ID'] == 1) {
